...
class GenerateReportView(APIView):
    ...
    def get(self, request, scan_id):
        ...
        # 1. Capture White Label Params (Defaults removed as requested)
        ...
        # 4. White Label Info (Right Aligned)
        ...
        p.drawRightString(width - 50, height - 98, f"Date: {report_date}")
    ...
    def post(self, request, *args, **kwargs):
        ...
        for host in parsed_data:
            for service in host['services']:
                ...
                if product != 'unknown' and version != 'unknown':
                    ...
                    service['vulnerabilities'] = []; service['vuln_count'] = 0
        ...
        try:
            ...
            return Response({
                ...
                "db_id": scan_id, # Crucial for Frontend
                "filename": file_obj.name,
                "scan_data": parsed_data
